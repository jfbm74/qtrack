export class Tooltip extends Element<import("../types/basic.js").AnyObject, import("../types/basic.js").AnyObject> {
    ...
    options: any;
    dataPoints: {
        chart: import("../dist/core/core.controller.js").default;
        label: any;
        parsed: any;
        raw: any;
        formattedValue: any;
...
export type InteractionItem = import('../dist/core/core.interaction.js').InteractionItem;
import Element from "../dist/core/core.element.js";
import Animations from "../dist/core/core.animations.js";
